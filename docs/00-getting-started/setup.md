...
- 対象ファイル：
  ...
  - `docs/01-development/development.md`（コマンド例）
  - `docs/04-project-specific/overview.md`（コマンド例）
  - `docs/00-getting-started/setup.md`（ディレクトリ名）
  - `tools/README.md`（コマンド例）
- 注意: 以下のMDファイルはテンプレートとして残します（置換しません）
  - `README.md`
  - `docs/02-deployment/deploy.md`
  - `docs/01-development/architecture.md`
  - `docs/05-decisions/README.md`
  - `docs/03-troubleshooting/troubleshooting.md`
- **個別に変更しても問題ない項目**：
...
[docs/02-deployment/deploy.md](../02-deployment/deploy.md) の「Secrets設定のスクリプト化」を参照
...
セットアップ時に問題が発生した場合は、[docs/03-troubleshooting/troubleshooting.md](../03-troubleshooting/troubleshooting.md) を参照してください。
