...
- [docs/00-getting-started/setup.md](../00-getting-started/setup.md): セットアップ手順
- [docs/01-development/development.md](../01-development/development.md): 開発ガイド
- [docs/02-deployment/deploy.md](../02-deployment/deploy.md): デプロイ手順
- [docs/01-development/architecture.md](../01-development/architecture.md): 設計判断・守るルール
