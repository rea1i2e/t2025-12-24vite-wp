 ...
 *   - text_en (string, 必須): 英語テキスト（br / wbr / span / strong / em のインラインタグ可）
...
<<?php echo $wrap_tag; ?> class="c-heading">
  <<?php echo $en_tag; ?> class="c-heading__en" data-fadein><?php echo wp_kses($en, ty_kses_inline()); ?></<?php echo $en_tag; ?>>
