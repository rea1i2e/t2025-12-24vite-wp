#!/bin/bash
# フォント圧縮コマンド（全グリフ）
# 使用方法: ./raw/fonts/font-compress.sh 入力フォントファイル名.ttf 出力ファイル名.woff2
# 使用例: ./raw/fonts/font-compress.sh ./raw/fonts/SourceSans3-VariableFont_wght.ttf ./src/assets/fonts/SourceSans3-VariableFont_wght.woff2
